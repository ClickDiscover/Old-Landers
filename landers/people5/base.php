                ...
                <div class="tablet-9 columns">
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns text-center">
                            <h1 class="text-left">
                                This Video, Sent By a Fan, Brought Ellen to Tears. Watch It Below...Will It Have the Same Effect On YOU?

                            </h1>
<img class="img-frame margin-bottom-20" src="<?= $assets ?>/images/ellencry3.jpg" alt="" align="center"></a>
...
<p class="text-left">
 ...
 <p class="text-justify"><b>[PEOPLE]</b> It's not often that Ellen publicly endorses new products.  It's less often that she's publicly brought to tears. The combination of those two occurrences convinced her to offer an unprecedented giveaway...to her entire audience!

 <p class="text-justify"> On the first Monday of 2016, Ellen announced a new partnership that will soon deliver her privately developed skin regimen to the general public.  Before it's sold in stores, and for the next 24 hours, she's extending a free sample to ALL her fans!

 <p class="text-justify"> Until recently Ellen was legally obligated to keep her skincare regimen private because of her partnership with Cover Girl. Now that she's now longer a spokesperson, she can admit it isn't their makeup causing her to look half her age. After many years of wondering, Ellen's finally allowed to uncover the truth behind her anti-aging secret. To prove how well it works, Ellen asked a studio guest, along with staff members, to try it for free. Their stories are detailed below.
 <p class="text-justify"> *Please* keep in mind: because of high demand the free offer expires in <b>24 hours</b>, but continue reading for all the fantastic details and testimonials... </p>
                            <img class="img-frame margin-bottom-20" src="<?= $assets ?>/images/ellenb4.jpg"" align="center"></a><br>
                ...
                <div class="tablet-3 columns hide-for-phone">
                    ...
                    <div class="row columns light-gray-bg padding-vert-20 text-center">
                        <div class="img-wrap text-center">
                             <p class="text-justify"><b>Ellen's TV Producer Just Posted This AMAZING Video of her trying Argireline Peptide Cream:</b><br>
