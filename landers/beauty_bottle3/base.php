...
<div class="col-md-2">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="<?= $step1_link ?>">Home <span class="sr-only">(current)</span></a></li>
        <li class="active"><a href="<?= $step1_link ?>">Product Reviews</a></li>
		 <li><a href="<?= $step1_link ?>">Organizing</a></li>
		  <li><a href="<?= $step1_link ?>">Recipes</a></li>
		   <li><a href="<?= $step1_link ?>">Diets & health</a></li>
			<li><a href="<?= $step1_link ?>">Relationship</a></li>
			<li><a href="<?= $step1_link ?>">Hot Items</a></li>
      </ul>
    ...
    <div class="container">
        <div class="row">
		   <ol class="breadcrumb">
  <li><a href="<?= $step1_link ?>">Home Page</a> </li>
  <li><a href="<?= $step1_link ?>"> Product Reviews</a></li>
  <li class="active"> Skin Care</li>
</ol>
		           <div class="col-md-8">
                  <h1 class="h1"> <b>Is This The Answer To All Our Aging Problems? You have to see it to believe it.</b></h1>
<!--                  <h4 class="h4">Special Report: We Bring You An Amazing Story About Kate, How Her Life Spiraled Out Of Control And How She Regained Control Of Her Body </h4>-->
                 ...
                 <blockquote><em>In a Recent Interview, Jackie Wilson Tells Us About Her Struggle With Bingo Wings After Having 4 Children. And Reveals Her Secret Fix! </em></blockquote>-->
                  ...
                  <div class="thumbsup-success-stories">
					<div class="video-container">
					         <br/><iframe src="https://www.youtube.com/embed/whv7FyPIFE0?autoplay=0&amp;disablekb=1&amp;fs=0&amp;start=0&amp;modestbranding=1&amp;playsinline=1&amp;rel=0&amp;showinfo=0&amp;color=white&amp;theme=light&amp;controls=0" frameborder="0" width="100%" height="386"></iframe>
					</div>
					<p><b>Let's not waste any time</b>--Kate has told you everything you need to know. Many have tried to discover the secret of looking staying young: is it botox, face lifts, or just good lighting? The truth is much simpler (and cheaper!) than that. It isn't their makeup that's causing them to look decades younger. After many years of trying, our sources finally uncover the truth behind the anti-aging secret that has taken Hollywood by storm - and it's one that clever women around the world have been secretly using too.</p>

					<h2>The Best Skin Solution You've Never Heard Of</h2>
					<p>Instead of throwing away precious dollars on expensive anti-aging skin creams that make big promises and don't work, one reader has discovered a skin product that erases years off her face for only a few dollars. Read on to find out more!</p>
					...
					<h2>Lauren's Solution:</h2>
					<p>After a year of doing thorough research and speaking to other women about their own skincare habits, she had little to no success with finding a solution. Lauren was close to giving up until, by chance, she heard from a friend about a product that was yielding real results and helping women take years off their skin. This product is called the <a href="<?= $step1_link ?>"><?= $step1_name ?></a>. Due to the many failed products she had tried in the past, Lauren was skeptical about such an easy fix even though the suggestion came from a trusted source, but luckily it takes almost no effort (and very little cost) to <a href="<?= $step1_link ?>"> give it a try</a>.</p>

					<h2>The Results</h2>

					<p>After only a few days of adding <a href="<?= $step1_link ?>"><?= $step1_name ?> </a> to her daily skin routine, she saw noticeable results in the mirror. After just two weeks the proof was staring her right in the face: this was giving her real results.</p>

					<p>Using <a href="<?= $step1_link ?>"><?= $step1_name ?> </a>, Lauren's results were noticeably better than what you'd find at medi-spas for $5,000 or more. This removed virtually 90% of all her wrinkles and problem areas. It tightened her face and neck, removing all signs of sagging, aging, and dehydrated skin. Lauren was able to see these dramatic anti-aging results simply by using a <b>free sample of <a href="<?= $step1_link ?>"><?= $step1_name ?> </a> for only 14 days.</b></p>

					<p>Her friends, husband, and family were all shocked. They were convinced she'd been secretly getting Botox, because her skin looked 20 years younger almost overnight! Soon, word got around as her friends starting using Lauren's secret, and not long after, her easy discovery was featured on The Doctor Oz Show!</p>
                  ...
                  <br>
                  <span class="none"><h2>Celebrities Who Use <b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b></h2>
				  <br>
    ...
    <div class="item">
	 ...
	 <div class="item">
      <img src="<?= $assets ?>/images/img2/celeb6.jpg" class="img-responsive" alt="Flower">
          ...
          even though I didn't have bingo wings. So I decided to do my own research and put <b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b> to the test. </p>
		   <div style="background-color:rgba(94, 94, 94, 0.05); padding:10px;">
                    <h2>The real secret to <b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b> involves two key ingredients:
</h2>
                    <br>
					<p>
					<b>1. Vitamin C<br/>
					...
					<p>
					These are both natural ingredients that work together to erase wrinkles and fine lines at the cellular level - below the surface of the skin - which is why they're so effective.</p>

					<p><b>Vitamin C</b> is the key to maintaining healthy, youthful skin. It's a powerful antioxidant that slows the rate of free-radical damage, which causes skin's dryness, fine lines, and wrinkles. It helps combat and even reverse time's effect on your skin, because it produces collagen - a protein which makes skin appear plump and firm. Applying Vitamin C to the skin topically is up to 20 times more effective than taking it orally.</p>

					<p><b>Hyaluronic Acid</b> works by binding to moisture. It can hold up to 1,000 times its weight in water, making it an excellent natural skin plumper. Hyaluronic Acid helps your skin repair and regenerate itself after suffering from dryness, environmental stresses, or irritation.</p>


                   <!-- <ul>
                      <li> Made from 18 - 100% all natural ingredients</li>
                      <li>Clinically tested by the Good Housekeeping Research Institute (comprised of the top 10 dermatlogists in the US)</li>
				  ...
				  <br>
				  <br>
				<p>					After seeing Lauren on the Dr Oz show, a growing list of A-list celebrities appear to be ditching their expensive Botox treatments for <b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b>, including Kim Kardashian and Kate Middleton. I placed my order for my free 60 day supply of <b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b> online through our <b><a href="<?= $step1_link ?>">You Should Know Promotion Link</a></b> and received my package 4 days later. It came in a discreet box and shipping was only $4.95!  <br></p>                    <br>
                 ...
                 <hr/>
                  <span class="none"><div>
					...
					<b><a href="<?= $step1_link ?>"> <?= $step1_name ?> </a></b> covers all the bases when it comes to skin creams and that is why I fully endorse these products!" <b>- Dr. Oz</b><br/><br/>
                    </p>
					<hr/>
                  </div></span>
                  <h2>Lauren's Story &amp; 14 Day <?= $step1_name ?> Results:</h2>
				...
				<p>"The trick is that <?= $step1_name ?> contains high concentrations of pure Vitamin C and Hyaluronic Acid in just the right concentrations. I also discovered that it contains all sorts of anti-oxidants, an ingredient called Dermaxyl (also known as facelift in a jar) and Ester-C (the active anti-aging compound in Vitamin C). The instructions were easy to follow but very specific: they're important to follow precisely because it does make a visible difference. You apply just a light coat of <?= $step1_name ?> on your face and neck after washing and drying your face just before bed time. I saw results almost overnight, but after 14 days, the results were literally shocking. I looked how I used to look 20 years ago!" - Lauren</p>
                  ...
                  <!--<b>My entire routine consisted of two simple steps :</b><br/>
                  <ol>
                    <li><a href="<?= $step1_link ?>"><b>Applied a sparing amount of <?= $step1_name ?> to my thighs (once in the morning and once before bed at night)</b></a></li>
                    <br>
                    <br>
                  ...
                  <div style="float: left; width: 154px; height: 250px;">
					...
					After both products were absorbed into my skin, my face looked firmer and had a beautiful glow to it.</p>
                  ...
                  <div style="background-color:rgba(94, 94, 94, 0.05); padding:10px; clear:both">
				   ...
				   <img src="<?= $assets ?>/images/eyes2.jpg" alt="" height="207" width="130"></div>
					...
					I was astonished by the results, and literally felt 15 years younger again. It was like watching all my wrinkles and fine lines vanish right off! Not only did my skin look younger, it also felt younger.

					Not only were the results amazing, they were incredibly easy to achieve, taking less than 15 minutes out of my day to apply the cream.
                    </p>
                  </div>
                  <div style="background-color:rgba(94, 94, 94, 0.05); padding:10px; clear:both">
                    <div style="float: left; width: 154px; height: 250px;">
                    ...
                    <p>
						...
						After the 2 weeks, my skin not only stayed that way, it actually improved every day until it became as beautiful and radiant as it was 20 years ago. By this point, all my friends and family were shocked. They couldn't believe the difference, and were convinced I was lying about not getting botox!</p>
					<p>	<b> By this point, all my friends and family were shocked. They couldn't
...
<!--				<div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?= $assets ?>/images/reg9.jpg" class="img-responsive" alt="Chania">
    </div>
 ...
 <div class="item">
      <img src="<?= $assets ?>/images/reg6.jpg" class="img-responsive" alt="Chania">
    </div>
	 <div class="item">
      <img src="<?= $assets ?>/images/reg5.jpg" class="img-responsive" alt="Chania">
    </div>
	 <div class="item">
      <img src="<?= $assets ?>/images/reg4.jpg" class="img-responsive" alt="Chania">
    </div>
	 <div class="item">
      <img src="<?= $assets ?>/images/reg3.jpg" class="img-responsive" alt="Chania">
    </div>
	 <div class="item">
...
<div>
 ...
 <br/>             <div class="clear"></div>
                            ...
                            <div class="UIImageBlock clearfix"> <a class="postActor UIImageBlock_Image UIImageBlock_MED_Image" href="http://www.facebook.com/tanyaporquez" target="_blank" tabindex="-1" aria-hidden="true"><img class="img" src="<?= $assets ?>/images/370176_564964504_308463864_q.jpg" alt=""/></a>
                              <div class="UIImageBlock_Content UIImageBlock_MED_Content">
                                <div class="postContainer fsl fwb fcb"> <a class="profileName" target="_blank" href="http://www.facebook.com/tanyaporquez">Tanya Porquez</a>
                                  <div class="postContent fsm fwn fcg">
                                    <div class="postText">I saw this product on CNN a while ago. I've been using this product for about 6 wks (<?= $step1_name ?> came in the mail in 3 days!). Honestly, this is unbelievable, all I have to say is WOW.</div>
                                    <div class="stat_elem">
                            ...
                            <div class="UIImageBlock clearfix"> <a class="postActor UIImageBlock_Image UIImageBlock_MED_Image" href="http://www.facebook.com/jennifer.jacksonmercer" target="_blank" tabindex="-1" aria-hidden="true"><img class="img" src="<?= $assets ?>/images/157804_21416303_1043059674_q.jpg" alt=""/></a>
                              <div class="UIImageBlock_Content UIImageBlock_MED_Content">
                                <div class="postContainer fsl fwb fcb"> <a class="profileName" target="_blank" href="http://www.facebook.com/jennifer.jacksonmercer">Beth Mcgee</a>
                                  <div class="postContent fsm fwn fcg">
                                    <div class="postText">A friend of mine used <span class="product1normal"></span> and recommended it to me 3 weeks ago. I ordered the products and received them within 3 days (although I didn't get the Free Trial). The results have been incredible and I can't wait to see what weeks 3 and 4 bring.</div>
                                    <div class="stat_elem">
                            ...
                            <div class="UIImageBlock clearfix"> <a class="postActor UIImageBlock_Image UIImageBlock_MED_Image" href="http://www.facebook.com/amanda.hickam" target="_blank" tabindex="-1" aria-hidden="true"><img class="img" src="<?= $assets ?>/images/370345_7008369_2025512953_q.jpg" alt=""/></a>
                              <div class="UIImageBlock_Content UIImageBlock_MED_Content">
                                <div class="postContainer fsl fwb fcb"> <a class="profileName" target="_blank" href="http://www.facebook.com/amanda.hickam">Amanda Hickam</a>
                                  <div class="postContent fsm fwn fcg">
                                    <div class="postText">Hey Christine, i just placed my order. I can't wait to get them!! Thanks, Manda xoxoxo.</div>
                                    <div class="stat_elem">
		   ...
		   <span class="none"><a href="<?= $step1_link ?>"><img src="<?= $assets ?>/images/Dr_Oz_GH_Oct-min.jpg" class="img-responsive" alt="" width="100%"/></a><br/>
                  <p><a href="<?= $step1_link ?>"><?= $step1_name ?></a> was recently featured Woman's Day as The Secret Wrinkle Buster they don't want you to know about!<br>
			    ...
			    <!-- <a href="<?= $step1_link ?>"><img src="<?= $assets ?>/images/sidebarba7.jpg" width="100%" style="height:320px;" class="img-responsive"  alt=""/></a><br/>-->
                  <p> "Better than ANY other face Cream I have ever tried. Don't spend your money on expensive department store crap. Your paying for advertising and packaging! This Cream is the best and cheapest. Have been using it ever day for the past year and I'll keep using it. I Wish I could give it 10 stars." <br/><b>June Witwicky</b><br/><b>Los Angeles, California</b><br/>
                    ...
                    <div class="mailchimp_block">
                      <div class="mailchimp-title" style="background:
					  #82ad40; color: white; width:100%; font-weight: bold; font-size: 16px; padding: 10px;">NEWSLETTER SIGNUP</div>
                      ...
                      <form action="<?= $step1_link ?>" method="post" name="newsletter_subscribe" id="newsletter_subscribe" >
                        ...
                        <div class="input_field" style="padding:10px;" id="name">
                          <label for="newsletter_name2">Name:</label>
                          <input id="newsletter_name2" type="text" name="name"  size="18" />
                        </div>
                        <div class="input_field" style="padding:10px;" id="email">
                  ...
                  <div style="z-index: 999;width:270px; float:right; margin-top:170px; " id="scrollingdiv"> <a href="<?= $step1_link ?>"><img src="../../img/junisse.png" width=290 alt=""/></a></div>
                  <br/>
				  </div>
        </div>
        <!-- /.row -->
...
<script>
  (function(d, s) {
    ...
    load("http://tracking.dietmachine.net/tracking202/static/landing.php?lpip=7499", "upxif");
  }(document, "script"));
  </script>
        </div>
    <!-- /.container -->
