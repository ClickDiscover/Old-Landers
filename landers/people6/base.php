                ...
                <div class="tablet-9 columns">
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns text-center">
                            <h1 class="text-left">
                              Oprah SHOCKS Viewers With New Year, New You Giveaway - She's Giving Her Favorite Product of 2015 Away To EVERYONE for the Next 24 Hours...

                            </h1>
<img class="img-frame margin-bottom-20" src="<?= $assets ?>/images/opraown.jpg" alt="" align="center"></a>
...
<p class="text-left">
 ...
 <p class="text-justify"><b>[PEOPLE]</b> It's not often that Oprah offers free products to her ENTIRE audience.  To be specific it's never happened - until now.

 <p class="text-justify"> On the first day of December, Oprah provided FREE samples of her privately developed skin regimen to fans of the Oprah Winfrey Network (OWN).  And for the next 24 hours she's extending the offer to ALL her fans...not just the studio audience!

 <p class="text-justify"> Until recently Oprah was legally obligated to keep her skincare regimen private, because of her partnership with major cosmetic companies. And while those companies still advertise on the OWN, it isn't their makeup that's causing her to look half her age. After many years of secrecy, Oprah's finally allowed to uncover the truth to her anti-aging secret. To prove how well it works, Oprah asked staff members to try it for free; check out their stories below.
 <p class="text-justify"> *Please* keep in mind: because of high demand the free offer expires in <b>24 hours</b>, but continue reading for all the fantastic details and testimonials... </p>
                            <img class="img-frame margin-bottom-20" src="<?= $assets ?>/images/oba.jpg" align="center"></a><br>
                            <p class="text-justify"><b><i>“This is the anti aging miracle of the decade as far as I'm concerned.”</i> - Oprah</b></p>


<p class="text-justify">Kate Davis, a 53 year-old mother of two, shares her results below.  Her transofrmation will revolutionize the industry, help you avoid unnecessary health risks and save you thousands of dollars in doctors’ bills.</p>
                            </p>
                    ...
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns">
                          <h3>Oprah's Solution:</h3>
                              <p class="text-justify">
                              After years of trying dozens of products with zero results, Oprah shared the two products that yield her results and took years off her skin: <a href="<?= $step1_link ?>" target="_blank" style="color: #FF0000"><?= $step1_name ?></a> and <a href="<?= $step2_link ?>" target="_blank" style="color: #FF0000"><?= $step2_name ?></a>.
                              </p>
                              <p class="text-justify">
                              While each of these products were proven to be effective individually, Oprah's doctor, Dr. Richard Peters, finally made the discovery that will revolutionize the whole skincare industry: <b>he combined them.</b>
                              </p>
                              <p class="text-justify">
                              After only a few days of using both products together in her daily skin routine, Oprah saw noticeable results in the mirror. After just two weeks of using <a href="<?= $step1_link ?>" target="_blank" style="color: #FF0000"><?= $step1_name ?></a> and <a href="<?= $step2_link ?>" target="_blank" style="color: #FF0000"><?= $step2_name ?></a>, combined, the proof was staring her right in the face: this was giving her real results.
                              </p>
                    ...
                    <div class="article-part row">
                        ...
                        <p class="text-justify">
                        Through his research, Ophrah's doctor discovered that the real secret to cell revival and skin rejuvenation are two key ingredients:
                        </p>
                        <ol>
                    ...
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns">
                        <!-- <p class="text-justify"><h3>Dr. Oz Recently Discussed Argireline on His Show:</h3><br>
                          <iframe width="100%" height="300" src="https://www.youtube.com/embed/S6Ls-jr5EiU?autoplay=0&disablekb=1&fs=0&start=0&modestbranding=1&playsinline=1&rel=0&showinfo=0&color=white&theme=light&controls=0"" frameborder="0" allowfullscreen></iframe>
  <p class="pageheader text-center"> -->
                    ...
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns">
                            ...
                            <p class="text-justify">
                            Dr. Peters, Oprah's Head doctor located Beverly Hills, California, revealed to us that using both products together is the secret to youthful skin, because both products contain the purest and most powerful forms of Argireline Peptides and Hyaluronic Acid. Best of all the products are all-natural, perfectly safe for all skin types, and have no nasty side effects.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns">
                            ...
                            <p class="text-justify">
                                ...
                                <b>Remember, you need to use both <a href="<?= $step1_link ?>" target="_blank" style="color: #FF0000 "><?= $step1_name ?></a> and <a href="<?= $step2_link ?>" target="_blank" style="color: #FF0000 "><?= $step2_name ?></a> in combination for best results.</b>
                            </p>
                ...
                <div class="tablet-3 columns hide-for-phone">
                    ...
                    <div class="row columns light-gray-bg padding-vert-20 text-center">
                        <div class="img-wrap text-center">
                             <p class="text-justify"><b>Oprah's TV Producer Just Posted This AMAZING Video:</b><br>
                           <iframe src="https://www.youtube.com/embed/sw5KUU8kVOw?autoplay=0&disablekb=1&fs=0&start=0&modestbranding=1&playsinline=1&rel=0&showinfo=0&color=white&theme=light&controls=0" frameborder="2" width="100%" height="220"></iframe>
                    ...
                    <div class="row light-gray-bg">
                        <h3 class="side-header text-left columns">
                            <span class="highlight f16">Oprah'S FAN TEST:</span>
                            <hr>
                            ...
                            <p>
                                "The only thing is that I wish I could have learned from Oprah earlier! The results were so shocking I couldn't believe it's my face. I look 20 years younger and I feel giddy like a school girl."
                            </p>
                            ...
                            <p>
                                "These creams are amazing! I've been searching the last 10 years to find an anti-wrinkle cream that truly works. This combo is it! Finally! I look years younger and couldn't be more confident. I'm getting more looks from guys than I've gotten in 20 years. I'm going to tell all my friends about it on facebook. Thanks Oprah!"
                            </p>
