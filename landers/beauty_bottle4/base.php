      ...
      <img src="<? $assets ?>/images/img2/celeb6.jpg" class="img-responsive" alt="Flower">
          ...
          even though I didn't have bingo wings. So I decided to do my own research and put <b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b> to the test. </p>
		   <div style="background-color:rgba(94, 94, 94, 0.05); padding:10px;">
                    <h2>The real secret to <b><a href="<?= $step1_link ?>"><?= $step1_name ?> Anti-Aging Cream</a></b> involves two key ingredients:
</h2>
                    <br>
					<p>
					<b>1. Vitamin C<br/>
                   ...
                   <!-- <ul>
                      ...
                      <li><b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b> has been proven to not only tone <b><a href="<?= $step1_link ?>">Bingo Wings</a></b>, but <b><a href="<?= $step1_link ?>">Cellulite</a></b>, <b><a href="<?= $step1_link ?>">Skin Lumps & Bumps</a></b>, <b><a href="<?= $step1_link ?>">Wrinkles</a></b>, and many more!
				  ...
				  <br>
				  <br>
				<p>					After seeing Lauren on the Dr Oz show, a growing list of A-list celebrities appear to be ditching their expensive Botox treatments for <b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b>, including Kim Kardashian and Kate Middleton. I placed my order for my free 60 day supply of <b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b> online through our <b><a href="<?= $step1_link ?>">You Should Know Promotion Link</a></b> and received my package 4 days later. It came in a discreet box and shipping was only $4.95!  <br></p>
				<!--
                  <p>After completing my research, I was ready to put <b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b> to the test. Though I didn't have bingo wings, I’ve had cellulite problems for years so I decided to do a test purely based on my legs. I placed my order for my free 60 day supply of <b><a href="<?= $step1_link ?>"><?= $step1_name ?></a></b> online through our <b><a href="<?= $step1_link ?>">You Should Know Promotion Link</a></b> and received my package 4 days later. It came in a discreet box and shipping was only $4.95!  <br>-->
                    <br>
		   ...
		   <span class="none"><a href="<?= $step1_link ?>"><img src="<? $assets ?>/images/Dr_Oz_GH_Oct-min.jpg" class="img-responsive" alt="" width="100%"/></a><br/>
			   ...
			   <a href="<?= $step1_link ?>"><img src="<? $assets ?>/images/sidebarba9.jpg" width="100%" style="height:320px;"  class="img-responsive" alt=""/></a><br/>
			    ...
			    <!-- <a href="<?= $step1_link ?>"><img src="<? $assets ?>/images/sidebarba7.jpg" width="100%" style="height:320px;" class="img-responsive"  alt=""/></a><br/>-->
                  ...
                  <div style="z-index: 999;width:270px; float:right; margin-top:170px; " id="scrollingdiv"> <a href="<?= $step1_link ?>"><img src="<?= $step1_image ?>" width=290 alt=""/></a></div>
                  <br/>
				  </div>
        </div>
        <!-- /.row -->
