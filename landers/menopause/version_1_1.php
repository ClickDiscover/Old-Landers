    ...
    <div class="container">
      <div class="row">
        ...
        <p>The product we're talking about is called <a href="<?= $step1_link ?>"><?= $step1_name ?></a>. You may have seen it in the news, on TV, or trending online as the safe and powerful "secret diet trick&rdquo; being used by models, celebrities and regular folk all across <?= $geo->name() ?>. <a href="<?= $step1_link ?>"><?= $step1_name ?></a>'s high anti-oxidant content and powerful fat burning properties make it a belly busting machine. Combine it with the detoxifying, cleansing and additional weight loss effect of a <a href="<?= $step2_link ?>"><?= $step2_name ?></a> and you see why this deserves a Special Report. But maybe the most important part is that <?= $step1_name ?> is finally available nationwide WITHOUT a prescription.</p>
          <p><strong>If you're interested in losing weight without diet or exercise, <a href="<?= $step1_link ?>"><?= $step1_name ?></a> and <a href="<?= $step2_link ?>"><?= $step2_name ?></a> is something you need to know more about.</strong></p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          ...
          <ul>
          <li>The health journal Lipids in Health &amp; Disease  showed that subjects who took <a href="<?= $step1_link ?>" class="step-link"><?= $step1_name ?> </a> and <a href="<?= $step2_link ?>"><?= $step2_name ?></a> lost an average of <?= $geo->weight(19.3) ?> in four weeks. Subjects did not change their diet or exercise habits during the study.</li>
          ...
          <li>When <a href="<?= $step1_link ?>" class="step-link"><?= $step1_name ?> </a> is taken with <a href="<?= $step2_link ?>"><?= $step2_name ?></a>, studies have also shown a 39% <b>reduction in cholesterol</b> along with a <?= $geo->length(2) ?> average reduction in belly fat over four weeks.</li> 

          <li>Subject in the study who took <?= $step1_name ?> and <?= $step2_name ?> lost an average of <?= $geo->weight(17) ?> more than study participants who were given a placebo. </li>
          ...
          <p>Of course, we’d never recommend <?= $step1_name ?> and <?= $step2_name ?> without firsthand knowledge. This is why we’d like to introduce our readers to Dolores Williams.</p>

          <h4><strong>Dolores Williams, 52, Lost <?= $geo->weight(21) ?> in 30 Days. Here’s How She Did It and How You Can, Too!</strong></h4>

          <p>When we were asking our staff if they knew any women who might be willing to test out <a href="<?= $step1_link ?>" class="step-link"><?= $step1_name ?></a> and <a href="<?= $step2_link ?>"><?= $step2_name ?></a> for our report, almost immediately our associate editor Christina Williams raised her hand.</p>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <p>My doctor was completely surprised – in a good way! I lost <?= $geo->weight(21) ?> in just one month. And I didn’t change my lifestyle in any way except with the addition of <a href="<?= $step1_link ?>" class="step-link"><?= $step1_name ?></a> and <a href="<?= $step2_link ?>"><?= $step2_name ?></a>.</p> <p>In just one month, I lost enough weight that my doctor no longer considers my weight a risk factor. Here’s to the long life ahead of me!</p>
  ...
  <section class="padding-tb-40 pinkbar">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
        <p><strong>The Results of Our Investigation:</strong> <a href="<?= $step1_link ?>"><?= $step1_name ?> </a> paired with <a href="<?= $step2_link ?>"><?= $step2_name ?></a> is an effective and safe way for women to lose weight. You’ll drop <?= $geo->unit('weight') ?> quickly which, in turn, will improve all areas of your overall health. As an unexpected side effect, 
