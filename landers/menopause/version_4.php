      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="benefits_v4">
            ...
            <ul>
              <li class="text-center">Burn fat by naturally boosting your metabolism</li>
              <li class="text-center">Remove unwanted cellulite, belly fat and arm fat</li>
              <li class="text-center">Increase your energy levels during the day</li>
              <li class="text-center">Increase the quality of your sleep during the night</li>
            </ul>
          </div>
          ...
          <div class="benefits_v4">
            ...
            <ul>
              <li class="text-center">Results in <strong>natural weight loss</strong> with no diet or exercise</li>
              <li class="text-center">Reduces or even eliminates hot flashes</li>
              <li class="text-center">Improves and stabilizes mood</li>
              <l class="text-center"i>Improves duration and quality of sleep</li>
            </ul>
          </div>
  ...
  <section class="padding-tb-40 pinkbar_v4">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
        <p><strong>The Results of Our Investigation:</strong> <a href="<?= $step1_link ?>"><?= $step1_name ?></a> is an effective and safe way for women to lose weight. You’ll drop <?= $geo->unit('weight') ?> quickly which, in turn, will improve all areas of your overall health. As an unexpected side effect,
  ...
  <div id="bottombar" style="background-color: #24e4ba;color: white;">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
        <a href="https://www.trysourcegarciniacambogiatrial.com/d/specialu/?AFID=170315&SID=&click_id=740219952&C1=&C2=&C3=">
          <button style="background-color: #e4ba24; color:white" class="btn btn-block btn-info claim-yours">Claim Yours!</button>
        </a>
    </div>
  </div>
