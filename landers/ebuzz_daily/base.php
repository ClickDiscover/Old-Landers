<!doctype html>
<html class="turbohub_2012"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><title>Mary Loses 27kg Thanks To A Controversial New Diet!</title>
...
<img src="<?= $assets ?>/images/cos1.png" width="950"></center>
...
<div id="header_wrap"><div id="header"><div id="site_title">
	<img src="<?= $assets ?>/images/hpages.png" width="122" height="32" alt="" class="auto-style1" style="float: left"></div><ul id="nav" class="hoverok"><li id="header_explore" class="singleton"><a tabindex="24" href="<?= $step1_link ?>" target="_blank">
		</a></li></ul></div></div>
...
<a href="index.html%3Fvoluumdata=vid..00000002-2cc7-46b2-8000-000000000000__vpid..e7f02800-68a0-11e5-85bd-e512fb12ef2f__caid..2b269cf9-b82c-40e9-90f6-bfcffc93b312__rt..R__lid..fdc52222-f9bd-4f17-94db-b4c2c6333223__oid1..a13ac17b-e8a2-42b3-9.html#" target="_blank" class="hubcomment_icon" onClick="ssToId('mod_27583893'); return false;"></a><a href="index.html%3Fvoluumdata=vid..00000002-2cc7-46b2-8000-000000000000__vpid..e7f02800-68a0-11e5-85bd-e512fb12ef2f__caid..2b269cf9-b82c-40e9-90f6-bfcffc93b312__rt..R__lid..fdc52222-f9bd-4f17-94db-b4c2c6333223__oid1..a13ac17b-e8a2-42b3-9.html#" id="hubcomment_counter" onClick="ssToId('mod_27583893'); return false;">16</a></span></div></div>
<ul id="crumbslist">
</ul>
</div><article><div id="title"><div class="title_box">
				<div class="headline"><span>How To Lose 17kg Of Stomach Fat In 5 Weeks </span>
...
<div style="width:328px; padding:0;margin-top:-108px">
        	...
        	<div style="padding: 17px 0 10px 0; text-align:center; color: #fff; font-size: 1em;color:#141414;line-height:1.2;">
        		Lose 17kg in 1 month with this diet trick celebrities are using...</div>

            <div  style="margin: 0;border: 1px solid #e1e1e1; padding: 10px; text-align: center; font-size: 16px; width: 330px;">
       	    	<a href="<?= $step1_link ?>" target="_blank"><img src="<?= $assets ?>/images/4.jpg"  class="info"></a>
                <div class="info-text">
                <h4>&nbsp;Mary (before her weight loss)</h4>
                <p>Mary (38) lost 27kg in just 5 weeks by using <a href="<?= $step1_link ?>" target="_blank">Garcinia Essentials</a>
		and <a href="<?= $step2_link ?>" target="_blank">Essential Cleanse</a></p>

		<div class="info-text">
                <h4>&nbsp;Media.</h4></div>
		<a href="<?= $step1_link ?>" target="_blank"><img src="<?= $assets ?>/images/img4.jpg"  class="info"></a>
		<p><a target="_blank" href="<?= $step1_link ?>">Garcinia Essentials </a>
                                and <a target="_blank" href="<?= $step2_link ?>">Essential Cleanse</a>: Super weight-loss combo featured in the Spring 2014 issue of Good Housekeeping.
                            </p>
		<a href="<?= $step1_link ?>" target="_blank"><img src="<?= $assets ?>/images/beforeaft.jpg"  class="info"></a>
		<p>"I love my new body and I love what I see in the mirror. I’ve tried dozens of products and treatments but none worked better than Garcinia Essentials and
		Essential Cleanse. Thank you from the bottom of my heart!"</p>
		...
		<a href="<?= $step1_link ?>" target="_blank"><img src="<?= $assets ?>/images/img7.jpg"  class="info"></a>
		<p>"It’s simply amazing. I can’t believe how quickly I saw results. Real results! I literally saw results after the first day. I can’t thank you enough, I have my youthful figure back" </p>
			...
			<p class="reading-time">read: 109k times</p>
			...
			<p>This revolutionary system reviewed below, called by some "The Holy Grail of Weight Loss" has been featured on
				...
				<a href="<?= $step1_link ?>" target="_blank"><font color="blue"><span>Garcinia
			    Cambogia</span></font></a>. It's been mentioned on TV as a "miracle in the medicine cabinet"
			    ...
			    all-natural
			    <a href="<?= $step2_link ?>" target="_blank"><font color="blue"><span>Essential Cleanse</span></font></a> for even more effective weight loss as published in a recent study.
</p>

				<p>According to Dr Chen (The guest host on the popular Dr TV show), <a href="<?= $step1_link ?>" target="_blank"><span>Garcinia Cambogia</span></a>
	...
	and blocks and stops fat, but it also is natural and safe."</em>
				 ...
				 <img src="<?= $assets ?>/images/31.jpg" width="530" height="330"/>
				...
				<blockquote class="article-quote">
						...
						<a href="<?= $step1_link ?>" target="_blank"><font color="blue"><span>Garcinia Essentials</a></font></span>
				and <a href="<?= $step2_link ?>" target="_blank"><font color="blue"><span>Essential Cleanse</span></font></a>.

                                They confess that it's the secret to their slim figure..and it worked for me!”</span>

					</blockquote>

				<p>Mary, a 36 year old mother of three from Melbourne, claims after she got injured playing touch footy last year,
			her weight gain went out of control. "I hurt my knee really bad, and with 3 kids to look after, my healthy lifestyle
			went out the window...I got lazy, really lazy! I couldn't stand for long periods so I'd order take out most nights." She says.
			"All I could do was sit, it was miserable but food made me happy...before I knew it I had put on a huge amount of weight."
			She could barely support her own weight anymore and had to use crutches.
			Her doctor told her that if she does not lose weight immediately, her life could be in danger.
					</p>

					<p>
					Not only did her rapid weight gain threaten her life, but also took a
					toll on her marriage. Mary's husband left her a couple months after
					her shocking revelation from her doctor. Before leaving, Mary's
					husband has told her that she was "unattractive" and "not the same person I married."
					Feeling that her life has hit rock bottom, she knew something had to change!
					</p>


					<a href="<?= $step1_link ?>" target="_blank"><center><img src="<?= $assets ?>/images/2.jpg" height="250" width="500" style="padding-right: 5px" alt="" class="img-responsive"></a>
				<span><font size="2">Mary - after dropping 27 kgs</span></font></center>

					<p>
					She took drastic action to lose weight. Mary tried her best to lose weight the conventional way, but
					the results weren't showing. She tried everything, from Atkins to Weight Watchers, from Jenny Craig to Cambridge, nothing seemed to work.
					</p>

					<p>
					She didn't know what to do next, until she saw 10 NEWS talk about a <a href="<?= $step1_link ?>" target="_blank"><font color="blue">strange exotic fruit</a></font> clinically proven to give drastic results fast; Garcinia pills in combination with a Toxin Cleanser. The combined effect is clinically proven to not just shred fat off your physique but flush out all the junk in your body and increase your metabolism without harming your immune system.
					</p>
					...
					<p><b>
					That day changed her life forever.</b> See lost 27 kg within 5 weeks and her kids couldn't be more proud of her. With the weight-loss transformation came more confidence and optimism in life! She even found a new love - which is the perfect revenge on her husband!
...
<b><p><a href="<?= $step1_link ?>" target="_blank">Garcinia</a> has been clinically proven to:</p></b>
...
<a href="<?= $step1_link ?>" target="_blank"><font color="blue"><?= $step1_name ?></a></font>. <?= $step1_name ?> is one of the most concentrated and purest forms of organic Garcinia on the market.
					</p>
	    ...
	    <tbody>
				...
				<p class="style33">
					After the fourth week, my final results were shocking. I lost an unbelievable 31 lbs since starting the Garcinia diet! Actually everyone at Daily for Women is kicking themselves for not having volunteered to be the guinea pig. Using both products in week 4, I lost an additional 11 lbs.
					</p>
                            </div>
                            <div class="clearfix"></div>
				...
				<span><font size="2"><em>"couldn't be happier after dropping 13kg in 1 month!"</em></span></font>
					...
					We are 100% convinced you can reach your weight loss goals with this amazing new diet!
						...
						document.write(""+mydate.getDate()+" "+month[mydate.getMonth()]+" "+mydate.getFullYear()+" ");
                            ...
                            <p class="note style33">Note: Brenda used both <a href="<?= $step1_link ?>" target="_blank">Garcinia Essentials</a>
			    and <a href="<?= $step2_link ?>" target="_blank">Essential Cleanse</a>
...
<hr>
				...
				What a jerk that guy is but just look at Mary now!! I have been using this weight loss combo for 3 weeks now, and I seriously look 5 years younger! Not quite as good as this Khloe Kardashian, but I will take it when it was less than 5 bucks for each! My tummy and arm fat is melting away more and more every day. Thank you so much for reporting on this!
					...
					Way to go Mary! I saw this combo on 7news a while ago and still using the combo. I've been using the products for about 6 wks (Garcinia Essentials came first, had to wait for Essential Cleanse for an extra day). Honestly, this is unbelievable, all I have to say is WOW..</p></div></div>
...
<div style="text-align:center; font:normal 16px arial; padding:2px;">
  <p><span style="FONT-SIZE: 15pt"><font color="#000000">Representations regarding the efficacy and safety of Garcinia Diet have not been scientifically substantiated or evaluated by the Food and Drug Administration.
  An emerging body of scientific evidence suggests that ingestion of Garcinia Diet, used in conjunction with a restricted diet and exercise program,
  can lead to a reduction in weight or body fat. Copies of two human clinical trials on Garcinia Super Diet may be found here:
  <a  href="<?= $assets ?>/study1.pdf" target="_blank" title="Benefits of Garcinia Cambogia">Garcinia Cambogia Study 1</a><br /> and <a  href="<?= $assets ?>/study2.pdf" target="_blank" title="Garcinia Cambogia Study #2">Garcinia Cambogia Human Study 2</a>.
...
Please always take time to read the terms and conditions on the Garcinia Essentials Extract website by clicking <a href="<?= $step1_link ?>">HERE</a> and clicking on "Terms & Conditions".
