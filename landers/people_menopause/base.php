      ...
      <div class="container">
          <div class="navbar-header">
              <!-- <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                <div class="col-sm-12 nav-img-container"><img src="<?= $assets ?>img/gear.png" class="center-block nav-img"></div>
              </button> -->
              <a href="<?= $step1_link ?>" class="navbar-brand"><img src="<?= $assets ?>/img/mobile-logo.jpg"></a>
          </div>
