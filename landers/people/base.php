...
<section class="content-box">
        <div class="container content">
            <div class="row">
                <div class="col-md-8">
                  <h1>Would You Spend $5 To Look 15 Years Younger? Christie Brinkley's New Wrinkle Remover Does Exactly That! Botox Doctors Are Outraged By Her Breakthrough!</h1>
                  ...
                  <p class="m-t-25"><strong><i>Christie Brinkley was featured on The Today Show with Dr. Oz to launch her new skincare and anti-aging line, known as L'Amour. Discover how at 61 she looks half her age and how you can use the exact same product as her to look years younger!</i></strong></p>
                   ...
                   <iframe width="100%" height="300" src="https://www.youtube.com/embed/Fu70gf106mw?rel=0" frameborder="0" allowfullscreen></iframe>
                    ...
                    <h5 class="text-center"><i>"I'm 61 and look 35 thanks to the ingredients found in <a href="<?= $step1_link ?>"><?= $step1_name ?></a>" - Christie Brinkley</i></h5>
                    <h4>So what is it?</h4>
                  ...
                  He said the second piece, when combined properly with Proprietary Bisophere, literally makes your face <strong> look two decades younger in weeks! </strong> QuSome works by binding to moisture. It can hold up to 1,000 times its weight in water, making it an excellent natural skin plumper. QuSome helps your skin repair and regenerate itself after suffering from dryness, environmental stresses, or irritation. He said one of, if not the only products you can buy over the counter with an effective concentration of QuSome was found in <a href="<?= $step1_link ?>" target="_blank"><?= $step1_name ?></a>.</p>
                    ...
                    <h5 class="text-center"><i>"I'm excited for everyone to be able to try <a href="<?= $step1_link ?>"><?= $step1_name ?></a> - it really is the fountain of youth in a bottle" </i></h5>
                    ...
                    <div class="row grey-box">
                        <div class="col-xs-12">
                            ...
                            <div class="row box-inner">
                                ...
                                <div class="col-sm-9 p-l-0 p-l-15-mobile">
                                    <p>"After five days of using <a href="<?= $step1_link ?>"><?= $step1_name ?></a> I was shocked at the drastic results.</p>
                    ...
                    <p><strong><sup><img src="<?= $assets ?>/images/cite.png"></sup> Before and after picture of Kim Allen. The picture on the right was taken after only 14 days of using <a href="<?= $step1_link ?>"><?= $step1_name ?></a> <sup><img src="<?= $assets ?>/images/cite2.png"></sup></strong></p>
                    <p></p>
                    <img src="<?= $assets ?>/images/comp1.jpg" class="img-responsive">
                    <h5 class="text-center"><i><strong>"My skin looks incredible...even younger and smoother than when I was 35 - Thank you <?= $step1_name ?>!"</strong> the grandma-of-two exclusively told People Magazine of her wrinkle transformation.</i></h5>
                    <p>
                    </p>
                    <h3>The Verdict:</h3>
                    <p>Using <a href="<?= $step1_link ?>"><?= $step1_name ?></a>, removed virtually 90% of all Kim's wrinkles and problem areas. It tightened her face and neck, removing all signs of sagging, aging, and dehydrated skin.</p>
                ...
                <div class="col-md-4">
                  <h5 class="m-b-0 pink-border-bottom">READER RESULTS</h5>
                    ...
                    <p class="m-b-5"><i>"Christie Brinkley's <a href="<?= $step1_link ?>"><?= $step1_name ?></a> is the absolute best wrinkle removing product I've ever used. I thought my days of looking young were long gone. I can't thank you enough for this!" </i></p>
                    <p><strong><i>Lacey Johnson <br>
                      Lincoln, NE </i></strong></p>
                    <!--STEPS-->
                    <div class="row revival-box2">
                        ...
                        <div>
                            <p class="m-b-5"><a href="<?= $step1_link ?>"><strong>CLICK HERE to Claim Your Trial of <?= $step1_name ?></strong> </a> </p>
                            <div style="text-align: center;">
                                <a href="<?= $step1_link ?>">
                                    <img src="<?= $step1_image ?>" width="215" height="190">
                                </a>
                            </div>
                        </div>
                        <div class="warning">
                  ...
                  <h5 class="m-b-0 pink-border-bottom">BEFORE &amp; AFTER</h5>
                    ...
                    <p><strong><i>Kelly McKay <br>
                    Boulder, CO</i></strong></p>
              </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <p class="m-b-5"></p>
                    <p><strong style="color:red">IMPORTANT: During Christie Brinkley's clinical testing it was proven that you MUST use this product DAILY to achieve similar results.</strong></p>
...
// -->
                    ...
                    <div class="row revival-box">
                        <div class="col-sm-4">
                            <img src="<?= $step1_image ?>" width="223" height="212" class="img-responsive rev">
                        </div>
                        <div class="col-sm-8 revival-text">
                            <img src="<?= $assets ?>/images/checkmark.png" style="vertical-align: middle; float: left; ">
                            <h4 style="padding-top:5px">Step 1:<a href="<?= $step1_link ?>"> Free Bottle Of <?= $step1_name ?></a></h4>
                            <a href="<?= $step1_link ?>"><img src="<?= $assets ?>/images/button.png" class="img-responsive button"></a>
