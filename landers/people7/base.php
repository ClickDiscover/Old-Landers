    ...
    <div class="hatmain" id="hatmain">
      <div id="hatgrey" class="hatmenu">
        <ul id="hatslots" class="hatslots">
          ...
          <li class="hat1250" id="espanolhat"><a href="<?= $step1_link ?>" target="" onclick="#">
    ...
    <div class="page-header-secondary">
      ...
      <div class="social-links">
        <ul class="social-links-items">
          ...
          <li class="social-link-item"> <a href="<?= $step1_link ?>" target="_blank" class="icon-instagram"><i class="fa fa-instagram"></i></a> </li>
...
<div id="container">
 ...
 <br/>
		 ...
		 <div>
          ...
          <div style="clear:both;"></div>
		  <p> In a recent interview on <i>The Today Show</i>, Gwen discusses her 20 year transformation with <a href="<?= $step1_link ?>"><?= $step1_name ?></a>, "The results were unbelievable! I feel like a brand new woman thanks to my new skin care regimen. <a href="<?= $step1_link ?>"><?= $step1_name ?></a> is a must-have for all of us women who are trying to keep our look fresh." </p>
		  <br>
	...
	<br>
        ...
        <!-- Begin: Article Header -->
        <div id="articleHeader">
          <h1 id="articleHeadline"><i><center> "Gwen Stefani's Anti-Aging Breakthrough, <a href="<?= $step1_link ?>"><?= $step1_name ?></a> Has Been Exposed!" </center> </i></h1>
		  <br>
        </div>
        <!-- End: Article Header -->
        <!-- End: Article Header -->
        ...
        <div class="side_block show_mobile">
            ...
            <div class="side_img">
            <div class="new_step2">
                    <div class="new_step2_left"><img src="<?= $step1_image ?>" alt="" /></div>
                ...
                <div class="fotter_area_top">
                    ...
                    <div class="f_mid_l_r"><div class="fotter_area_mid">
                      ...
                      <a href="<?= $step1_link ?>"> <div class="share_comment">Share</div></a>
                       ...
                       <div class="mid_right_comment">
                       I saw this on CNN a while ago and still using <?= $step1_name ?>!. I've been using this product for about 6 wks. Honestly, this is unbelievable, all I have to say is WOW Gwen is totally right! Already have my two best friends hooked on it and they put in their order today
                       </div>
                       <div class="bot_right_comment">
                      ...
                      <a href="<?= $step1_link ?>"> <div class="share_comment">Share</div></a>
                       ...
                       <div class="mid_right_comment">
                       Gosh I went through something similar with my ex! And Gwen is right, this product works! A friend of mine used <?= $step1_name ?> and recommended it to me 3 weeks ago. I ordered the product and received them within 3 days I think (although I didn't get the free trail offers). The results have been incredible and I can't wait to see what weeks 3 and 4 bring.
                       </div>
                       <div class="bot_right_comment">
                       <a href="<?= $step1_link ?>"><div class="up_arrow"></div></a>
                       <a href="<?= $step1_link ?>"><div class="down_arrow"></div></a>
                      ...
                      <a href="<?= $step1_link ?>"> <div class="share_comment">Share</div></a>
                       ...
                       <div class="mid_right_comment">
                       Wow, this works great for Gwen Stefani! I've done my research, Thanks for the free samples guys. I'll make sure I leave my results. Good luck with you and the kids Gwen!
                       </div>
                       <div class="bot_right_comment">
                       <a href="<?= $step1_link ?>"><div class="up_arrow"></div></a>
                       <a href="<?= $step1_link ?>"><div class="down_arrow"></div></a>
                      ...
                      <a href="<?= $step1_link ?>"> <div class="share_comment">Share</div></a>
                       ...
                       <div class="mid_right_comment">
                       I saw <?= $step1_name ?> on the news. Thank you for sharing this tip! I just put in my order :).
                       </div>
                       <div class="bot_right_comment">
                       <a href="<?= $step1_link ?>"><div class="up_arrow"></div></a>
                       <a href="<?= $step1_link ?>"><div class="down_arrow"></div></a>
                      ...
                      <a href="<?= $step1_link ?>"> <div class="share_comment">Share</div></a>
                       ...
                       <div class="mid_right_comment">
                       I'm probably a bit older than most of you folks. but <?= $step1_name ?> actually worked for me too! LOL! I wasn't expecting it to but I'm happy. I can't say anything more exciting.Thanks for your inspirations! Gwen you look better than ever, your husband is going to miss what he had!
                       </div>
                       <div class="bot_right_comment">
                       <a href="<?= $step1_link ?>"><div class="up_arrow">1</div></a>
                       <a href="<?= $step1_link ?>"><div class="down_arrow"></div></a>
        ...
        <div id="rail-social-module" class="property-people selected-newsletter" data-source="inarticle_peday_rightrail" data-fsub="1113197361">
          ...
          <footer class="panels">
            ...
            <div class="panel pinterest_panel">
              ...
              <div class="social-widget"> <a title="Pinterest" data-pin-do="buttonFollow" href="<?= $step1_link ?>" target="_blank"> PEOPLE Magazine<b></b><i></i> </a> </div>
            </div>
            <div class="panel instagram_panel">
              <div class="follow-copy">Follow us on Instagram:</div>
              <div class="social-widget"> <a title="Instagram" href="<?= $step1_link ?>" target="_blank"> <img src="<?= $assets ?>/images/blank.png" alt="Instagram"/> </a> </div>
            </div>
  ...
  <div id="footer" class="footer-v2">
    ...
    <div id="footer-v2-links">
      <div class="footer-list-wrapper">
        ...
        <ul class="footer-list footer-list-advertise">
          <li> <a target="_blank" class="adv-online" href="<?= $step1_link ?>">Online</a> and <a target="_blank" class="adv-magazine" href="<?= $step1_link ?>">Magazine</a> </li>
        </ul>
      </div>
      <div class="footer-list-wrapper">
    ...
    <div id="footer-v2-newsletter">
      <div id="newsletter_signup_footer_2" class="clearfix cheetah_form">
        <div class="container">
          <form id="newsletter-footer-form" name="newsletter-footer-form" target="footer-submitiframe" method="post">
        ...
        <div class="container">
          <form>
            ...
            <fieldset>
              ...
              <a class="submit-button"><img src="<?= $step1_image ?>"/></a>
            </fieldset>
          ...
          <a class="see-more" href="<?= $step1_link ?>">see all newsletters</a> </div>
...
<!-- <script src="jquery.sticky-sidebar-scroll.js"></script> -->
