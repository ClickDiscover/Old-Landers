...
<html class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="images/people-main.css">
        <link rel="stylesheet" href="images/people-article-main.css">
        <link rel="stylesheet" href="images/overrides.css">
...
<div id="page-header" class="page-header">
    <div class="page-header-inner">
        <div id="ad-page-header-promotion" class="ad-page-header-promotion" style="position: absolute; top: 15px; height: 100px; width: 290px;">
            <img src="images/4free.PNG">
        </div><!-- /.ad-page-header-promotion -->

        <div class="page-header-logo page-header-logo-people">
            <a href="http://dftrax.com/click/1" data-page-header-track="N1">People</a>
        </div>
        <div class="page-header-logo page-header-logo-premium">
            <a href="http://dftrax.com/click/1" data-page-header-track="N1">People Premium</a>
        </div>
    ...
    <div id="primary-nav" class="primary-nav">
        <div class="primary-nav-inner">
            <div class="mini-header-logo-people">
                <a href="http://dftrax.com/click/1">People.com</a>
            </div>
            <ul class="primary-nav-items">
                <li class="primary-nav-item primary-nav-item-home">
                    <a href="http://dftrax.com/click/1" data-page-header-track="N2">Home</a>
                </li>
                <li class="primary-nav-item primary-nav-item-news">
                    <a href="http://dftrax.com/click/1" data-page-header-track="N3">News</a>
                </li>
                <li class="primary-nav-item primary-nav-item-video">
                    <a href="http://dftrax.com/click/1" data-page-header-track="N4">Video</a>
                </li>
                <li class="primary-nav-item primary-nav-item-photos">
                    <a href="http://dftrax.com/click/1" data-page-header-track="N5">Photos</a>
                </li>
                <li class="primary-nav-item primary-nav-item-style">
                    <a href="http://dftrax.com/click/1" data-page-header-track="N6">Style</a>
                </li>
                <li class="primary-nav-item primary-nav-item-babies">
                    <a href="http://dftrax.com/click/1" data-page-header-track="N7">Babies</a>
                </li>
                <li class="primary-nav-item primary-nav-item-royals">
                    <a href="http://dftrax.com/click/1" data-page-header-track="N8">Royals</a>
                </li>
                <li class="primary-nav-item primary-nav-item-premium">
                    <a href="http://dftrax.com/click/1" data-page-header-track="N9">Premium</a>
                </li>
                <li id="primary-nav-item-more" class="primary-nav-item primary-nav-item-more">
                    <a href="http://dftrax.com/click/1" class="has-nav-group" data-nav-group-id="secondary-nav-group-more" data-page-header-track="N10">More</a>
                </li>
                <li class="primary-nav-item is-highlighted">
                    <a href="http://dftrax.com/click/1" data-page-header-track="N17">Subscribe</a>
                </li>
            </ul>
    ...
    <div id="secondary-nav" class="secondary-nav">
        <div id="secondary-nav-group-more" class="secondary-nav-group">
            <div class="secondary-nav-group-inner clearfix">
                <a href="http://dftrax.com/click/1" class="secondary-nav-panel secondary-nav-panel-great-ideas" data-page-header-track="N11">More Food</a>
                <a href="http://dftrax.com/click/1" class="secondary-nav-panel secondary-nav-panel-pets" data-page-header-track="N12">More Pets</a>
                <a href="http://dftrax.com/click/1" class="secondary-nav-panel secondary-nav-panel-red-carpet" data-page-header-track="N13">More Red Carpet</a>
                <a href="http://dftrax.com/click/1" class="secondary-nav-panel secondary-nav-panel-tvwatch" data-page-header-track="N14">More TV Watch</a>
                <a href="http://dftrax.com/click/1" class="secondary-nav-panel secondary-nav-panel-unfiltered" data-page-header-track="N15">More Unfiltered</a>
                <a href="http://dftrax.com/click/1" class="secondary-nav-panel secondary-nav-panel-country" data-page-header-track="N16">More Country</a>
            </div>
                ...
                <div class="tablet-9 columns">
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns text-center">
                            <h1 class="text-left">
                                Ellen Officially Endorses New Age Defying Skin Combo - Yours for Free as Part of Her 12 Day Giveaway!
                                
                            </h1>
<a href="http://dftrax.com/click/1" target="_blank"><img class="img-frame margin-bottom-20" src="images/" alt="" align="center"></a>                            
<a href="http://dftrax.com/click/1" target="_blank"><img src="images/peoplebar.png" alt="" align="center"></a>                            
<p class="text-left">
 ...
 <p class="text-justify"><b>[PEOPLE]</b> At 57, Ellen Degeneres is looking better than ever. She looks even more radiant and youthful than she did when she was years younger! Many have tried to discover her secret: is it botox, face lifts, or just good lighting?
 
 <p class="text-justify"> The truth is much simpler (and cheaper!) than that.  For the first time this year, Ellen is offering a giveaway to all her viewers...not just her audience.  
 
 <p class="text-justify"> And for the next 24 hours, it's yours for FREE as part of her on-line 12 Day Giveaway!  
 
  <p class="text-justify"> Until recently she was legally obligated to keep it under wraps due to her relationship with Cover Girl. And while she's still a Cover Girl spokesperson, it isn't their makeup that's causing her to look half her age. After many years of wondering, Ellen finally uncovered the truth to her anti-aging secret.
                              
                                
 <p class="text-justify"> That's right; last week she shared the secret to looking 10 to 15 years younger fast, without the potential risks of surgery or botox - and for the next 24 hours it's yours for FREE. To prove how well it works, Ellen chose a number of longtime fans to try it out for free and share the results on live TV!</p>
                            <a href="http://dftrax.com/click/1" target="_blank"><img class="img-frame margin-bottom-20" src="images/"" align="center"></a><br>
                            <p class="text-justify"><b><i>“This is the anti aging miracle of the decade as far as I'm concerned.”</i> - Ellen</b></p>

<p class="text-justify">Brenda Davis, a 53 year-old mother of three from Los Angeles, California was on of those lucky fans. Brenda's testimonial will revolutionize the industry, help you avoid unnecessary health risks and save you thousands of dollars in doctors’ bills.</p>
<p class="text-justify">Like most women, Brenda didn’t have the extra cash to try out every celebrity-endorsed anti-aging “miracle cream” out there, let alone splurge on expensive elective medical procedures, like plastic surgery or facelifts.</p>
                        </div>
                    </div>
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns text-center">
                            ...
                            <p class="text-justify"><h3>Check Out Brenda's Amazing Video:</h3><br>
                            <iframe width="600" height="315" src="https://globalskincr.files.wordpress.com/2015/05/90-second-wrinkle-eraser-live-demo.mp4" frameborder="0"></iframe>
                                <p class="pageheader text-center">

                                <p class="pageheader text-center">
                                    <sup><img src="images/cite.png" width="25" height="19"></sup>
                                        Brenda Davis, a 53 year old mother of 3, calls <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000"></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000"></a> The Fountain of Youth
                                    <sup><img src="images/cite2.png" width="25" height="19"></sup>                                
                                </p>
                        </div>                       
                    </div>
                    ...
                    <div class="article-part row">
                        ...
                        <h3>Ellen's Solution:</h3>
                            ...
                            After years of trying dozens of products with zero results, Ellen shared the two products that yield her results and took years off her skin: <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000"></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000"></a>.
                            </p>
                            <p class="text-justify">                    
                            While each of these products were proven to be effective individually, Ellen and her doctor's finally made the discovery that will revolutionize the whole skincare industry: <b>she combined them.</b>
                            </p>
                            <p class="text-justify">                    
                            After only a few days of using both products together in her daily skin routine, she saw noticeable results in the mirror. After just two weeks of using <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000"></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000"></a>. combined, the proof was staring her right in the face: this was giving her real results.
                            </p>
                            <p class="text-justify">                    
                            Using the two products together, Brenda's results were noticeably better than what you'd find at medi-spas for $5,000 or more. This combination removed virtually 90% of all her wrinkles and problem areas. It tightened her face and neck, removing all signs of sagging, aging, and dehydrated skin. Brenda was able to see these dramatic anti-aging results simply by using <b>free samples of both products for only 30 days</b>.
                            </p>
                            <p class="text-justify">                    
                            ...
                            <p class="text-justify">                    
                            Brenda and Ellen are now sharing this secret with women everywhere. Using this method, she effectively erased 20+ years from her skin. It's changed her life and completely astonished everyone around her, even total strangers!
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="article-part row">
                        ...
                        <p class="text-justify">
                        Through her research, Ellen discovered that the real secret to cell revival and skin rejuvenation are two key ingredients:
                        </p>
                        <ol>
                    ...
                    <div class="article-part row">
                        ...
                        <p class="text-justify">
                        Celebrities around the world like Cindy Crawford, Jennifer Aniston, and Kelly Ripa have all admitted to using <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000 "></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000 "></a> to maintain their youthful glow.
                        </p>
                        </div>
                    </div>
                    ...
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns">
                            <a href="http://dftrax.com/click/1" target="_blank"><img class="img-frame" src="images/btralmnd.jpg" alt="" align="center"></a>
                            <p class="pageheader text-center">
                                <sup><img src="images/cite.png" width="25" height="19"></sup>
                                    Celebs have been raving about <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000 "></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000 "></a>. They confess that it's the secret to their youthful skin.
                                <sup><img src="images/cite2.png" width="25" height="19"></sup>    
                            </p>
                            <p class="text-justify">
                            Dr. Richard Peters, a prominent dermatologist based in Beverly Hills, California, revealed to us that using and together is the celebrity secret to youthful skin because both products contain the purest and most powerful forms of Argireline Peptides and Hyaluronic Acid. Best of all the products are all-natural, perfectly safe for all skin types, and have no nasty side effects.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns padding-bottom-20">
                            <a href="http://dftrax.com/click/1" target="_blank"><img class="img-square img-frame margin-right-15" src="images/droz.jpg" alt="" align="left"></a>
                            <p class="text-justify">
                    ...
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns">
                            <h3>Brenda's Story & 14 Day Cell Revival Results:</h3>
                            <p class="text-justify">
                                The trick is to combine <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000 "></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000 "></a>. These two products both contain high concentrations of pure Argireline Peptides and Hyaluronic Acid in just the right concentrations. I also discovered that they contain all sorts of anti-oxidants, an ingredient called Dermaxyl (also known as facelift in a jar) and Ester-C (the active anti-aging compound in Argireline Peptides). The instructions were easy to follow but very specific: they're important to follow precisely because it does make a visible difference. You apply just a light coat of on your face and neck after washing and drying your face, and gently pat and around the eye area before bed time. I saw results almost overnight, but after 14 days, the results were literally shocking. I looked how I used to look 20 years ago!
                            </p>
                        </div>
                    </div>
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns padding-bottom-20">
                            ...
                            <div class="show-for-phone">
                                <div class="phone-12 columns text-center padding-bottom-20">
                                    <a href="http://dftrax.com/click/1" target="_blank"><img class="img-frame" src="images/eyes1.jpg" alt=""></a>
                                </div>
                                <p class="text-justify">
                                    <b>[Day 1]</b> After the first day of using <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000 "></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000 "></a> together, I was surprised at how wonderful they both made my skin feel. It felt like every last pore on my face was being tightened and pulled by a gigantic vacuum cleaner. 
                                </p>
                                <p class="text-justify">
                    ...
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns padding-bottom-20">
                            ...
                            <div class="show-for-phone">
                                <div class="phone-12 columns text-center padding-bottom-20">
                                    <a href="http://dftrax.com/click/1" target="_blank"><img class="img-frame" src="images/eyes2.jpg" alt=""></a>
                                </div>
                                <p class="text-justify">
                                    <b>[Day 5]</b> After five days of using <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000 "></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000 "></a>, I was shocked at the drastic results.
                                </p>
                                <p class="text-justify">
                    ...
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns padding-bottom-20">
                            ...
                            <div class="show-for-phone">
                                <div class="phone-12 columns text-center padding-bottom-20">
                                    <a href="http://dftrax.com/click/1" target="_blank"><img class="img-frame" src="images/eyes3.jpg" alt=""></a>
                                </div>
                                <p class="text-justify">
                    ...
                    <div class="article-part row">
                        <div class="tablet-12 phone-12 columns">
                            ...
                            <p class="text-justify">
                                ...
                                <b>Remember, you need to use both <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000 "></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000 "></a> in combination for best results.</b>
                            </p>

                            <p class="text-justify">
                                For your convenience, I have provided the links that Brenda used to sign up for her Free Trials of both <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000 "></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000 "></a> Anti-Aging Treatments. Use the links below and you will get the lowest possible shipping price as well.<br><br>
                    ...
                    <div class="article-part row hide-for-phone">
                        <div class="tablet-12 phone-12 columns text-center">
                        <a href="http://dftrax.com/click/1" target="_blank"><img class="margin-bottom-20" src="images/offer.jpg" alt=""></a> 
                            <p class="text-left border-dotted padding-bottom-10"><sub><b class="red-color">Note</b>: Brenda used both <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000 "></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000 "></a> to erase her wrinkles, we suggest to use both products together to get the best results possible.
                       </sub>
                            </p>
                        </div>
                    </div>                    
                    <div class="article-part row padding-bottom-20">
                        ...
                        <div class="show-for-phone text-center">
                            <div class="phone-12 columns padding-top-20 text-center">
                                ...
                                <p class="text-left">Receive A Free 30 Day Supply Of <b></b></p>
                                ...
                                <div class="phone-12 columns padding-bottom-20">
                                    <a href="http://dftrax.com/click/1" target="_blank" class="button expand radius green-gradient">
                                        <h5><span class="button-prodheader">GET A FREE TRIAL TODAY!</span></h5>
                                    </a><br><br>
                                    <p>Trial Promotion Ends: Saturday, January 09, 2016</p>
                        ...
                        <div class="hide-for-phone">
                            <div class="tablet-7 phone-8 columns padding-top-20">
                                ...
                                <p>Receive A Free 30 Day Supply Of <b></b><br>
                    ...
                    <div class="article-part row padding-bottom-20">
                        <div class="show-for-phone text-center">
                            <div class="phone-12 columns padding-top-20 text-center">
                                ...
                                <div class="tablet-12 columns padding-bottom-20">
                                    <a href="http://dftrax.com/click/2" target="_blank" class="button expand radius blue-gradient">
                                        <h5><span class="button-prodheader">GET A FREE TRIAL TODAY!</span></h5>
                                    </a><br><br>
                                    <p>Trial Promotion Ends: Saturday, January 09, 2016</p>
                                    <p>(Only <b>5</b> Trials Left)</p>    
                        ...
                        <div class="form-wrap">
                            <div class="tablet-11 phone-12 tablet-centered columns">
                                ...
                                <div data-alert class="alert-box success radius hidden">
                                    ...
                                    <a href="http://dftrax.com/click/1" class="close">&times;</a>
                                </div>
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment1.jpg" width="50" height="50" alt="">
                                </div>
...
<div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment2.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
                                        <b>Katy Barrott</b><br>
Never even thought about combining the products. I am very much pleased after using this product.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment3.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
I saw this on the news. How lucky is this mom to have found this opportunity!?!?! Thank you for sharing this tip! I just ordered both products.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment4.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
                                        <b>Julie Keyse</b><br>
probably I'm a bit older than most of you folks. but this combo worked for me too! LOL! I can't say anything more exciting.Thanks for your inspirations!
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment5.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
<div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment6.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
I love the I'm going to give these products a chance to work their magic on me. I've tried everything out there and so far nothing has been good enough to help me.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment7.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
worked for me! I worked just like I thought it would. It was easy enough and I just want others to know when something works.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment8.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
Thanks for the info, just started mine.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment9.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
                                        <b>Alice Chang</b><br>
Been so busy with the kids lately that never able to find deals like this. Clever idea whoever came up with it!
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment10.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
Always impressed with the deals you guys dig up, got both trials. Can't wait to see what you've got lined up next week.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment11.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
<div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment12.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
Hey Christine, i just placed my order. I can't wait to get them!! Thanks, Aimee xoxoxo.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment13.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
My mom just e-mailed me this, a friend at work had told her about it. i guess it works really well
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment14.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
Telling all my friends about this, thanx for the info
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment15.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
                                        <b>Jill Phongsa</b><br>
wasn't sure about ordering online but this deal seals it for me, didn't want to miss out. checked out the pages and all is encrypted and good. looking forward to my new looks
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment16.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
I've gone ahead and placed an order. I can't wait to get started and see what happens.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment17.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
<div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment18.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
I have tried so much of this kind of stuff, in one sense I want to try it but in the back of my mind I am thinking, yeah right!! Someone please reassure me it works.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment19.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
I tried the wrinkle cream thing a while ago and it worked pretty good but I didn't know about step two. I'll give it a try and let you know.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment20.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
...
For once I was able to do something nice for myself without feeling guilty about the cost.
                        ...
                        <div class="tablet-12 columns">
                            <div class="comment row border dashed border-bottom border-gray">
                                <div class="phone-3 tablet-2 columns text-center">
                                    <img src="images/comment21.jpg" width="50" height="50" alt="">
                                </div>
                                <div class="phone-9 tablet-10 columns">
                                    <p class="justify">
                ...
                <div class="tablet-3 columns hide-for-phone">
                    ...
                    <div class="row columns light-gray-bg padding-vert-20 text-center">
                        <div class="img-wrap text-center">
                            <a href="http://dftrax.com/click/1" target="_blank"><img class="magazine-shadow" src="images/" alt="" align="center"></a>
                        </div>                        
                    </div>
                    <div class="row columns light-gray-bg margin-vert-20">                        
                        <p class="text-left">Ellen raves about the <a href="http://dftrax.com/click/1" target="_blank" style="color: #FF0000 "></a> and <a href="http://dftrax.com/click/2" target="_blank" style="color: #FF0000 "></a> anti-aging combo in a recent show.</p>
                    </div>
                    ...
                    <div class="row light-gray-bg">
                        <h3 class="side-header text-left columns">
                            ...
                            <hr>
                            <a href="http://dftrax.com/click/1" target="_blank"><img class="magazine-shadow margin-bottom-20" src="images/commonright1.jpg" alt="" align="center"></a>
                            <p>
                                "I love my new skin and I love what I see in the mirror. I've tried dozens of products and treatments but none worked better than  and . Thank you from the bottom of my heart!" 
                            </p>
                            <p class="columns"><sub>—<b><i>Beatrice King<br>San Jose, California</i></b></sub></p>
                            
                            <a href="http://dftrax.com/click/1" target="_blank"><img class="magazine-shadow margin-bottom-20" src="images/commonright2.jpg" alt=""></a>
                            <p>
                            ...
                            <a href="http://dftrax.com/click/1" target="_blank"><img class="magazine-shadow margin-bottom-20" src="images/commonright3.jpg" alt=""></a>
                            <p>
                            ...
                            <a href="http://dftrax.com/click/1" target="_blank"><img class="magazine-shadow margin-bottom-20" src="images/commonright4.jpg" alt=""></a>
                            <p>
                                "These creams are amazing! I've been searching the last 10 years to find an anti-wrinkle cream that truly works. This combo is it! Finally! I look years younger and couldn't be more confident. I'm getting more looks from guys than I've gotten in 20 years. I'm going to tell all my friends about it on facebook. Thanks Dr Oz!" 
                            </p>
                            <p class="columns"><sub>—<b><i>Rebecca Johnson<br>Los Angeles, California</i></b></sub></p>
                            
                            <a href="http://dftrax.com/click/1" target="_blank"><img class="magazine-shadow margin-bottom-20" src="images/commonright5.jpg" alt=""></a>
                            <p>
                            ...
                            <div class="step margin-top-20 text-center">
                                <figure class="figure text-center">
                                    ...
                                    <p><strong>Step 1: </strong></p>
                                        <a href="http://dftrax.com/click/1" target="_blank"><img src="images/" alt=""></a>
                                    </div>
                            ...
                            <div class="step">
                                <figure class="figure text-center">
                                    <div class="img-wrap text-center">
                                        ...
                                        <a href="http://dftrax.com/click/2" target="_blank"><img src="images/" alt=""></a>
                                    </div>
                                        <p><strong>FREE Trials Limited<br><sup>(while supplies last)</sup></strong></p>
                                </figure>
                                <a href="http://dftrax.com/click/2" target="_blank" class="button expand radius blue-gradient">
        ...
        <div class="row floating-bar" id="floating-bar">
            <div class="phone-6 columns">
                <a href="http://dftrax.com/click/1" target="_blank" class="button expand green-gradient">
                    <span class="button-header">GET YOUR RISK FREE TRIAL OF</span>
                    <span class="button-subheader"></span>
                </a>
            </div>
            <div class="phone-6 columns">
                <a href="http://dftrax.com/click/2" target="_blank" class="button expand blue-gradient">
                    <span class="button-header">GET YOUR RISK FREE TRIAL OF</span>
                    <span class="button-subheader"></span>
                </a>
            </div>
        ...
        <script>window.jQuery || document.write('<script src="images/jquery-1.11.0.min.js"><\/script>')</script>
